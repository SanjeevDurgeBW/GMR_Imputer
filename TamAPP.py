...
# PRODUCT_MODEL_MAP = {
#     "lv_turbo": {
#         "model": os.path.join(MODEL_DIR, "lv_turbo_model.pkl"),
#         "checksum": os.path.join(MODEL_DIR, "lv_turbo.pkl.sha256"),
#         "blob_model": "lv_turbo_model.pkl",
#         "blob_checksum": "lv_turbo_model.pkl.sha256"
#     },
#     "lv_egr": {
#         "model": os.path.join(MODEL_DIR, "lv_egr_model.pkl"),
#         "checksum": os.path.join(MODEL_DIR, "lv_egr_model.pkl.sha256"),
#         "blob_model": "lv_egr_model.pkl",
#         "blob_checksum": "lv_egr_model.pkl.sha256"
#     },
#     "cv_turbo": {
#         "model": os.path.join(MODEL_DIR, "cv_turbo_model.pkl"),
#         "checksum": os.path.join(MODEL_DIR, "cv_turbo_model.pkl.sha256"),
#         "blob_model": "cv_turbo_model.pkl",
#         "blob_checksum": "cv_turbo_model.pkl.sha256"
#     },
#     "cv_egr": {
#         "model": os.path.join(MODEL_DIR, "cv_egr_model.pkl"),
#         "checksum": os.path.join(MODEL_DIR, "cv_egr_model.pkl.sha256"),
...
#         await async_download_blob(
#             container_name='models',
#             blob_name=info["blob_model"],
#             download_file_path=info["model"]
#         )
#         await async_download_blob(
#             container_name='models',
#             blob_name=info["blob_checksum"],
#             download_file_path=info["checksum"]
#         )
#         verify_checksum(info["model"], info["checksum"])
#     except Exception as e:
#         logger.error(f"Error in async_download_and_verify_model: {e}\n{traceback.format_exc()}")
#         raise
# # --------------new code--------------------------
...
#         model_pipeline = joblib.load(info["model"])
